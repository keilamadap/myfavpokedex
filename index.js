/*! For license information please see main.db36fb73.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      463: function (e, t, n) {
        ...
        function Hl(e, t, n, r) {
          ...
          "object" === typeof l && null !== l
            ? (a.context = Cl(l))
            : ((l = Ta(t) ? za : Na.current), (a.context = Oa(e, l))),
        ...
        function ws(e) {
          ...
          do {
            ...
            if (((e = t.return), 0 === (32768 & t.flags))) {
              if (null !== (n = Ki(n, t, Tu))) return void (zu = n);
            } else {
              if (null !== (n = qi(n, t)))
        ...
        function js(e, t, n, r, a, o) {
          ...
          if (((r = e), "function" === typeof e)) Ts(e) && (i = 1);
            ...
            e: switch (e) {
              ...
              case L:
                return (
                  ((e = Os(13, n, t, a)).elementType = L), (e.lanes = o), e
                );
              case z:
                return (
  ...
  !(function () {
    ...
    (function () {
        ...
        var c = (function (e, t) {
            ...
            var n = "string" === typeof e ? P(e) : e,
              ...
              u = r
                ...
                : t;
            return { pathname: u, search: V(l), hash: W(i) };
          })(a, l),
          f = i && "/" !== i && i.endsWith("/"),
          d = (o || "." === i) && n.endsWith("/");
      ...
      function ce() {
        return se() || I(!1), t.useContext(oe).location;
      }
      function fe(e) {
          ...
          t.useCallback(
            function (e, t) {
              if ((void 0 === t && (t = {}), i.current))
                if ("number" !== typeof e) {
                  var a = A(e, JSON.parse(o), l, "path" === t.relative);
                  "/" !== n &&
      ...
      function pe(e, n) {
        ...
        return t.useMemo(
          function () {
            return A(e, JSON.parse(o), l, "path" === r);
          },
          [e, o, l, r]
        );
      }
      ...
      function be(e, n, r) {
        ...
        return a.reduceRight(function (e, o, i) {
          var u = o.route.id ? (null == l ? void 0 : l[o.route.id]) : null,
            s = r ? o.route.errorElement || t.createElement(he, null) : null,
            c = function () {
              return t.createElement(
                ye,
                {
      ...
      var Ie = (function () {
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (e.prev = 0),
                          (n = "https://pokeapi.co/api/v2/pokemon/".concat(t)),
                          (e.next = 4),
                          fetch(n)
                        );
                      case 4:
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (t = l.length > 0 && void 0 !== l[0] ? l[0] : 50),
        ...
        Ve = n(184),
        We = function () {
          var e = (0, t.useContext)(Be).favoritePokemons;
        ...
        He = function (e) {
          ...
          return (0, Ve.jsxs)("div", {
            ...
            children: [
              (0, Ve.jsx)("span", {
                onClick: r,
                children: (0, Ve.jsx)("div", { children: "\xab " }),
              }),
              (0, Ve.jsxs)("div", {
                children: ["\xa0\xa0\xa0 ", t, " de ", n, "\xa0\xa0\xa0\xa0"],
              }),
              (0, Ve.jsx)("span", {
                onClick: a,
                children: (0, Ve.jsx)("div", { children: " \xbb" }),
              }),
            ],
          });
        },
        Qe = function (e) {
          var n = (0, t.useContext)(Be),
            r = n.favoritePokemons,
            a = n.updateFavoritePokemons,
            l = e.pokemon,
            o = de(),
            i = r.includes(l.name) ? "\u2764\ufe0f" : "\ud83d\udda4";
          return (0, Ve.jsxs)("div", {
            ...
            children: [
              (0, Ve.jsx)("div", {
                ...
                children: (0, Ve.jsx)("img", {
                  ...
                  onClick: function (e) {
                    return (t = l.id), void o("/details/".concat(t));
                    var t;
                  },
                }),
              }),
              (0, Ve.jsxs)("div", {
                ...
                children: [
                  (0, Ve.jsxs)("div", {
                    className: "card-top",
                    children: [
                      (0, Ve.jsx)("h3", { children: l.name }),
                      (0, Ve.jsxs)("div", { children: ["# ", l.id] }),
                    ],
                  }),
                  (0, Ve.jsxs)("div", {
                    ...
                    children: [
                      (0, Ve.jsx)("div", {
                        ...
                        children: l.types.map(function (e, t) {
                          return (0,
                          Ve.jsx)("div", { className: "pokemon-type-text", children: e.type.name }, t);
                        }),
                      }),
                      (0, Ve.jsx)("button", {
        ...
        Ke = function (e) {
          ...
          return (0, Ve.jsxs)("div", {
            children: [
              ...
              n
                ? (0, Ve.jsx)("div", { children: "Carregando..." })
                : (0, Ve.jsx)("div", {
                    className: "pokedex-grid",
                    children:
                      t &&
                      t.map(function (e, t) {
                        return (0, Ve.jsx)(Qe, { pokemon: e }, t);
                      }),
                  }),
            ],
          });
      ...
      var Ye = function () {
                ...
                return je().wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 2:
                        return f(!0), h(!1), (e.next = 6), Ie(t);
                      case 6:
                        (n = e.sent) ? (g([n]), r(0), o(1)) : h(!0), f(!1);
                      case 9:
                      case "end":
                        return e.stop();
                    }
        ...
        Ge = function (e) {
          var t = e.id,
            n = e.pokemonName,
            r =
              "https://assets.pokemon.com/assets/cms2/img/pokedex/full/".concat(
                (function (e) {
                  return (
                    1 === e.length && (e = "00" + e),
                    2 === e.length && (e = "0" + e),
          ...
          return (0, Ve.jsx)("img", {
            id: "single-pokemon-img",
            src: r,
            alt: "Pokemon ".concat(n),
          });
        },
        Xe = function () {
          var e = (function () {
            ...
            n = i((0, t.useState)(""), 2),
            r = (n[0], n[1], i((0, t.useState)(null), 2)),
            a = r[0],
            l = r[1],
            o = i((0, t.useState)(null), 2),
            u = o[0],
            s = o[1],
            c = i((0, t.useState)(null), 2),
            f = c[0],
            d = c[1],
            p = i((0, t.useState)(null), 2),
            h = (p[0], p[1]),
            m = i((0, t.useState)(null), 2),
            v = m[0],
            g = m[1],
            y = "https://pokeapi.co/api/v2/pokemon/".concat(e, "/"),
            b = (function () {
              var e = Fe(
                je().mark(function e(t) {
                  return je().wrap(function (e) {
                        ...
                        case 0:
                          fetch(t)
                            .then(function (e) {
                              if (!e.ok)
                                throw Error(
                                  "N\xe3o foi poss\xedvel encontrar o conte\xfado"
                                );
                              return e.json();
                            })
                            .then(function (e) {
            ...
            (0, Ve.jsxs)("main", {
              children: [
                (0, Ve.jsx)("section", {
                  ...
                  children: (0, Ve.jsx)(We, {}),
                }),
                (0, Ve.jsx)(Ge, { id: e, pokemonName: v }),
                (0, Ve.jsxs)("section", {
                  className: "characteristics",
                  children: [
                    (0, Ve.jsx)("h2", {
                      className: "title-charac",
                      children: " # characteristics ",
                    }),
                    (0, Ve.jsx)("br", {}),
                    (0, Ve.jsxs)("p", {
                      children: [
                        (0, Ve.jsx)("b", { children: "\u2b50\ufe0f Height" }),
                        ":\xa0",
                        (0, Ve.jsxs)("span", { children: [a / 10, "\xa0m"] }),
                      ],
                    }),
                    (0, Ve.jsx)("hr", { className: "horizontal-rule" }),
                    (0, Ve.jsxs)("p", {
                      children: [
                        (0, Ve.jsx)("b", { children: "\u2b50\ufe0f Weight" }),
                        ":\xa0",
                        (0, Ve.jsxs)("span", { children: [u / 10, "\xa0kg"] }),
                      ],
                    }),
                    (0, Ve.jsx)("hr", { className: "horizontal-rule" }),
                    (0, Ve.jsxs)("p", {
                    ...
                    (0, Ve.jsx)("div", {
                      ...
                      children:
                        ...
                        f.map(function (e) {
                          return (0,
                          Ve.jsx)("div", { className: "ability", children: e.ability.name });
                        }),
                    }),
                  ],
                }),
      ...
      a.createRoot(document.getElementById("root")).render(
        (0, Ve.jsx)(ze, {
          children: (0, Ve.jsx)(t.StrictMode, {
            children: (0, Ve.jsxs)(Ee, {
              children: [
                (0, Ve.jsx)(Se, { path: "/", element: (0, Ve.jsx)(Ye, {}) }),
                (0, Ve.jsx)(Se, {
                  exact: !0,
                  path: "/details/:id",
                  element: (0, Ve.jsx)(Xe, {}),
...
//# sourceMappingURL=main.db36fb73.js.map
